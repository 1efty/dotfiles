...
# ZSH complains about permissions on completion directories
...
plugins=(aws brew git docker-compose docker doctl golang kubectl laravel ssh-agent zsh-autosuggestions zsh-history-substring-search zsh-syntax-highlighting)
